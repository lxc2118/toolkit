...
//	@Test
	public void testEncode() throws WriterException, IOException {
		...
		// 内容
		String content = "http://aqxy.028tg.cn/";
		// 图像类型
		String format = "png";
		Map<EncodeHintType, Object> hints = new HashMap<EncodeHintType, Object>();
		hints.put(EncodeHintType.CHARACTER_SET, "UTF-8");
		// 生成矩阵
		BitMatrix bitMatrix = new MultiFormatWriter().encode(content, BarcodeFormat.QR_CODE, IMAGE_WIDTH, IMAGE_HEIGHT,
				hints);
	...
	public static void main(String[] args) {
		new ZxingUtil().encode("http://coolshell.cn/articles/10590.html", 600, 600, "D:\\logo.png", "D:\\2013-01.png");
	}
}
